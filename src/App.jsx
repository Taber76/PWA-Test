import {
	Home, Contacts, ContactRegister, ContactUpdate, Login, Orders,
	OrderRegister, OrderUpdate, Users, UserRegister, UserUpdate, PasswordChange,
	ItemRegister, ItemUpdate, Items, Instructions
} from './views';
